...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("C:/Users/lenovo/Desktop/Notepad/Music/","")
...
def Play():
    ...
    song=f'C:/Users/SHAURYA CHAWLA/Downloads/{song}'
...
def Previous():
    ...
    temp2=f'C:/Users/lenovo/Desktop/Notepad/Music/{temp2}'
...
def Next():
    ...
    temp=f'C:/Users/lenovo/Desktops/Notepad/Music/{temp}'
